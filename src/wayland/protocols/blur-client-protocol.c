...
static const struct wl_message org_kde_kwin_blur_manager_requests[] = {
	{ "create", "no", blur_types + 1 },
	{ "unset", "o", blur_types + 3 },
};

WL_PRIVATE const struct wl_interface org_kde_kwin_blur_manager_interface = {
...
static const struct wl_message org_kde_kwin_blur_requests[] = {
	{ "commit", "", blur_types + 0 },
	{ "set_region", "?o", blur_types + 4 },
	{ "release", "", blur_types + 0 },
	{ "set_strength", "u", blur_types + 0 },
};

WL_PRIVATE const struct wl_interface org_kde_kwin_blur_interface = {
	"org_kde_kwin_blur", 1,
	4, org_kde_kwin_blur_requests,
	0, NULL,
};
