...
#define ORG_KDE_KWIN_BLUR_SET_STRENGTH 3
 ...
 * @ingroup iface_org_kde_kwin_blur
 */
#define ORG_KDE_KWIN_BLUR_SET_STRENGTH_SINCE_VERSION 1
 ...
 */
static inline void
org_kde_kwin_blur_set_strength(struct org_kde_kwin_blur *org_kde_kwin_blur, uint32_t strength)
{
	wl_proxy_marshal_flags((struct wl_proxy *) org_kde_kwin_blur,
			 ORG_KDE_KWIN_BLUR_SET_STRENGTH, NULL, wl_proxy_get_version((struct wl_proxy *) org_kde_kwin_blur), 0, strength);
}
